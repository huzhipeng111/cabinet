...
import 'package:cabinet/widget/QRScannerPage.dart';
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Visibility(
                                                    visible: deviceDatas[index].status == 2 || deviceDatas[index].status == 0,
                                                    child: Container(
                                                ...
                                                Visibility(
                                                  visible: deviceDatas[index].status == 1,
                                                  child: Container(
                                                    alignment: Alignment.center,
                                                    width: ScreenUtil()
                                                        .setWidth(200),
